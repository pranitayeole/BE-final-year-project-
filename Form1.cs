...
namespace MultiFaceRec
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            imgOrignal.Save(Application.StartupPath + "/TrainedImages/" + len + ".bmp");
            db.ConnectToDatabase();
            db.ExecuteSqlCommand("Insert into tbldata values('" + textBox1.Text + "','" + textBox2.Text + "','" + Application.StartupPath + "/TrainedImages/" + len + ".bmp" + "')");
